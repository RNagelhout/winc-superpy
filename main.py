...
product_parser = subparser.add_parser("date_today", help="Use to change de date of today. Choose new_date.")
...
product_parser.add_argument("purchase_date", type=str, help="Type here the purchase date of the product (format : yyyy-mm-dd).")
...
product_parser.add_argument("product_number", type=int, help="Type here the productnumber of the product (format : int).")
product_parser.add_argument("product_amount", type=int, help="Type here the total amount of product in this purchase")
product_parser.add_argument("selling_date", type=str, help="Type here the purchase date of the product (format : yyyy-mm-dd).")
...
def Superpy():
    ...
    if args.command == "date_today":
        outcome = dateToday(new_date=args.new_date)
